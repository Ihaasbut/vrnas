import { PRICE_PLANS_CARDS_DATA } from "./components/pricePlansCards/PricePlansCards.consts";
import { PricePlansData } from "./PricePlans.types";

export const PRICE_PLANS_DATA: PricePlansData = {
   ...
   pricePlansCards: PRICE_PLANS_CARDS_DATA,
};
